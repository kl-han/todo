    ...
    return Column(
      children: [
        Expanded(
          child: Row(
            children: [
              Expanded(child: _QuadrantPanel(group: groups[0], state: state)),
              Expanded(child: _QuadrantPanel(group: groups[1], state: state)),
            ],
          ),
        ),
        Expanded(
          child: Row(
            children: [
              Expanded(child: _QuadrantPanel(group: groups[2], state: state)),
              Expanded(child: _QuadrantPanel(group: groups[3], state: state)),
            ],
          ),
        ),
